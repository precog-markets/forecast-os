---
name: forecast-os
description: "Use ForecastOS whenever a user wants information about the possible future: odds, likelihoods, probabilities, forecasts, predictions, future scenarios, decision/planning uncertainty, what are the chances, will this happen, do you want to bet/back this belief, requests to create/fund/trade/check prediction markets, whether there is a prediction market about a topic, market discovery, Polymarket/Kalshi/Precog context, or requests to investigate and report back when no market or prediction exists. Search read-only market context before guessing probabilities, draft market specs, ask for Base/Arbitrum USDC collateral selection when missing, inspect .forecastos workflow memory, generate wallet/action-tool handoff intents, run the bundled action bridge for human-approved Precog create/fund/consume steps, and enforce no wallet custody, no signing, and no direct funding without operator approval."
---
