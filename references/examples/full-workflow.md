...
6. If Precog is not configured, return a clear TODO/unavailable result.
7. Move to Precog approval, funding, and prediction consumption only when the workflow state allows it.
...
Without a trusted adapter, funding remains TODO/mock.
